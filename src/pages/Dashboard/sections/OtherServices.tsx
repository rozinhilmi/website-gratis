...
const OtherServices = (props: { other_services: any }) => {
  return (
    <Stack
    ...
    >
      <Stack alignItems={"center"}>
        ...
        >
          {props.other_services.description}
        </Text>
      </Stack>
      <Stack gap={"80px"} my={"30px"}>
        {props.other_services.services.map((item: any, index: number) => (
          <HStack
